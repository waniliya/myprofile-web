      ...
      <div className='row flex-lg-row align-items-center g-5 py-5'>
        <div className='col-10 col-sm-8 col-lg-6'>
            ...
            <ul>
              ...
              <li><b>Intermediate: </b> CSS, Javascript, PHP, Java/Java EE, C/C++, SQL</li>
              <li><b>Beginner: </b>Python, React JS, Visual Basic</li></ul>
        </div>
        <div className='col-lg-6'>
        <h4>Software/Framework</h4>
        <ul>
              <li><b>Web/Software Development: </b> React JS, ExpressJS, Eclipse, Jupiter, Matlab</li>
